...
const rule = {
    meta: {
        ...
        messages: {
            guardSuperCall: 'Super calls to lifecycle callbacks should be guarded in case the base class does not implement them'
        }
    },
    create(context) {
         ...
         * @return {boolean}
         */
        function isSuperHook(node, hook) {
         ...
         * @return {boolean}
         */
        function isSuperHookExpression(node, hook) {
         ...
         * @return {boolean}
         */
        function isUnguardedSuperHook(node, hook) {
